...
const ENDPOINT = "https://obscure-castle-55977.herokuapp.com/";


const Game = (props: { location: { search: string } } | any) => {
    ...
    const [playedCardsPile, setPlayedCardsPile] = useState<any>([]);
    const [drawCardPile, setDrawCardPile] = useState<any>([]);

    const [isChatBoxHidden, setChatBoxHidden] = useState<boolean>(true);
    const [isUnoButtonPressed, setUnoButtonPressed] = useState<boolean>(false);
    ...
    useEffect(() => {
        ...
        socket.on("message", (message: never) => {
    ...
    //some util functions
    const checkGameOver = (arr: string | any[]) => {
        return arr.length === 1;
    };

    const checkWinner = (arr: string | any[], player: any) => {
    ...
    //driver functions
    const onCardPlayedHandler = (played_card: string) => {
                        ...
                        <div>
                            ...
                            {currentUser === 'Player 1' && <>
                                <div className='player2Deck' style={{ pointerEvents: 'none' }}>
                                    ...
                                    {player2Deck.map((item: string, i: React.Key | null | undefined) => (
                                        <img
                                            key={i}
                                            className='Card'
                                ...
                                <br />
                                <div className='middleInfo' style={turn === 'Player 2' ? { pointerEvents: 'none' } : {}}>
                                ...
                                <br />
                                <div className='player1Deck' style={turn === 'Player 1' ? {} : { pointerEvents: 'none' }}>
                                    <p className='playerDeckText'>Player 1</p>
                                    {player1Deck.map((item: string, i: React.Key | null | undefined) => (
                                        <img
                                            key={i}
                                            className='Card'
                                            onClick={() => onCardPlayedHandler(item)}
                            ...
                            {currentUser === 'Player 2' && <>
                                ...
                                <br />
                                <div className='middleInfo' style={turn === 'Player 1' ? { pointerEvents: 'none' } : {}}>
                                ...
                                <br />
                                <div className='player2Deck' style={turn === 'Player 1' ? { pointerEvents: 'none' } : {}}>
                                    <p className='playerDeckText'>Player 2</p>
                                    {player2Deck.map((item: string, i: React.Key | null | undefined) => (
                                        <img
                                            key={i}
